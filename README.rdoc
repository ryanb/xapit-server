...
* terms_with_weight: a comma separated list of terms and their weight. "kangaroo,1,galexy,2"
...
Pass in a query and get a list of matching document ids and percentages in response.
